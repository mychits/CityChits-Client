...
const LeadWhatsappWelcomeMessage = () => {
  ...
  const sendWhatsapp = async () => {
    ...
    try {
      ...
      const test = await api.post("/whatsapp/lead-welcome-message", {
    ...
    try {
      ...
      const data = reportResponse.data?.map((lead, index) => {
        ...
        return {
          ...
          leadPhone,
          //  groupId,
          referredBy: lead?.lead_agent?.name,
          enrollDate,
        };
      });
...
export default LeadWhatsappWelcomeMessage;
