                ...
                {openActionId === item._id && (
                    <div className="absolute right-6 top-10 bg-white border rounded-lg shadow-lg w-40 z-50">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 w-full px-4 py-2 hover:bg-gray-100 text-violet-600"
                        >
                            <UserPlus size={18} />
                            <span>Assign</span>
                        </button>
                            ...
                            {!activeTab && (
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                    <div onClick={() => setActiveTab("complaints")} className="group cursor-pointer">
                                        <div className="relative overflow-hidden rounded-xl bg-white border border-violet-200 shadow-md hover:shadow-lg transition-all duration-300">
                                            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-violet-600 to-violet-700 opacity-5 group-hover:opacity-10 rounded-full -mr-16 -mt-16 blur-xl" />
                                            <div className="relative p-7">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        <div className="inline-flex items-center justify-center w-14 h-14 bg-violet-50 rounded-lg">
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-4xl font-bold text-violet-600">{complaints.length}</p>
                                                ...
                                                <div className="flex items-center justify-between pt-4 mt-6 border-t border-gray-100">
                                                    ...
                                                    <div className="p-1.5 rounded-lg bg-gradient-to-br from-violet-600 to-violet-700 opacity-0 group-hover:opacity-100 transition">
                                                        <ChevronRight className="w-4 h-4 text-white" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-violet-600 to-violet-700 opacity-0 group-hover:opacity-100 transition" />
                                        </div>
                                    </div>
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                                        ...
                                        <div
                                            ...
                                            className={`relative overflow-hidden rounded-xl bg-white shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer border-2 ${filters.status === "" ? "border-violet-500 ring-1 ring-violet-500" : "border-transparent"}`}
                                        >
                                            <div className="p-6 bg-violet-300">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        <div className="inline-flex items-center justify-center w-12 h-12 bg-violet-100 text-violet-600 rounded-lg">
                                                            <Users size={24} />
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-3xl font-bold text-violet-600">{complaints.length}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mb-4 border rounded-lg p-4 bg-gray-50">
                                        ...
                                        <div className="mt-3">
                                            <button onClick={() => setFilters({ subject: "", department: "", assignedTo: "", status: "", fromDate: "", toDate: "" })} className="px-4 py-2 bg-violet-200 rounded text-sm hover:bg-violet-300">Reset Filters</button>
                                        </div>
                                    </div>
                                    <div className="bg-white rounded-xl shadow border border-gray-300 w-full overflow-x-auto p-4">
                        ...
                        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                            <div className="bg-white rounded-lg p-6 w-[400px]">
                                ...
                                <div className="flex justify-end gap-3">
                                    ...
                                    <button onClick={confirmAssign} className="px-4 py-2 bg-violet-600 text-white rounded" disabled={!selectedAgent}>Assign</button>
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                            <div className="bg-white rounded-xl shadow-lg w-[95%] max-w-4xl max-h-[90vh] overflow-auto p-6 relative">
                                ...
                                <div className="flex justify-end mt-6 gap-3">
                                    ...
                                    {viewMode === "assign" && (
                                        <button onClick={confirmAssign} disabled={!selectedAgent} className="px-4 py-2 bg-violet-600 text-white rounded disabled:opacity-50">Assign</button>
                                    )}
                                </div>
                            </div>
                        </div>
