...
const EmailMarketingMenu = () => {
  const emailmarketingCategories = [
  
    {
      ...
      href: "/market-menu/email-marketing/due-email-marketing",
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Manage and organize your Email Marketing
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {emailmarketingCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage email, and more with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default EmailMarketingMenu;
