...
const MarketingMenu = () => {
  const marketingCategories = [
  
    {
      ...
      description: "Manage whatsapp Marketing",
      icon: <FaWhatsapp className="w-8 h-8" />,
      color: "from-violet-600 to-violet-700",
      lightColor: "bg-violet-50",
      borderColor: "border-violet-200",
      href: "/market-menu/whatsapp-marketing",
      stats: "Active Whatsapp Marketing",
    },
    {
      id: 2,
      ...
      href: "/market-menu/email-marketing",
      stats: "Active Email Marketing",
    },
     {
      id: 2,
      title: "SMS Message",
      ...
      lightColor: "bg-amber-50",
      borderColor: "border-violet-200",
      href: "/market-menu/sms-marketing",
      stats: "Active SMS",
    },
     {
      id: 2,
      title: "RCS",
      description: "RCS",
      icon: <MdAddIcCall className="w-8 h-8" />,
      color: "from-violet-600 to-violet-700",
      lightColor: "bg-violet-50",
      borderColor: "border-violet-200",
      href: "/market-menu/rcs-marketing",
      stats: "Active RCS",
    },
    //  {
    //   id: 2,
    ...
    //   icon: <RiMoneyRupeeCircleLine className="w-8 h-8" />,
    //   color: "from-amber-600 to-amber-700",
    //   lightColor: "bg-amber-50",
    //   borderColor: "border-amber-200",
    //   href: "/market-menu/payment-link-marketing",
    //   stats: "Active Payment Link",
    // },
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Manage and organize your Marketing
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage WhatsApp, email, and more with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
