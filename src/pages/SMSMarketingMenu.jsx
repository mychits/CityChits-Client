...
const SMSMarketingMenu = () => {
  const smsmarketingCategories = [
  
    {
      id: 1,
      title: "SMS Message ",
      description: "Manage SMS Messages Portal",
        ...
        <div className="flex-1">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {smsmarketingCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage SMS with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default SMSMarketingMenu;
