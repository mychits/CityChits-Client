...
//                           errors.total_paid_amount ? 'border-red-500' : 'border-gray-300 focus:border-violet-500'
//                         }`}
...
//                         className={`w-full px-3 py-2 border rounded-md ${
//                           errors.other_payments ? 'border-red-500' : 'border-gray-300 focus:border-violet-500'
//                         }`}
...
//                         className={`w-full px-3 py-2 border rounded-md ${
//                           errors.transaction_id ? 'border-red-500' : 'border-gray-300 focus:border-violet-500'
//                         }`}
...
//                         className={`w-full px-3 py-2 border rounded-md ${
//                           errors.note ? 'border-red-500' : 'border-gray-300 focus:border-violet-500'
//                         }`}
//                         rows="3"
