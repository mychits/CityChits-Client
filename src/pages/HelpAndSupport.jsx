  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3 mb-4 justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-white bg-violet-800 text-sm font-medium px-4 py-2 rounded-md hover:bg-violet-300 transition cursor-pointer"
              >
                Enquire Call
              </button>
              ...
              <Link
                to="/help-support"
                className="text-white bg-violet-800 text-sm font-medium px-4 py-2 rounded-md hover:bg-violet-300 transition mx-2"
              >
                Raise Ticket
              </Link>
            </div>
      ...
      <div className="w-full">
        <h2 className="text-xl font-bold mb-6 text-violet-800 border-b pb-2">Enquire Call</h2>
        ...
        <Form form={form} layout="vertical" onFinish={onFinish} className="font-sans">
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-violet-100">
            <label className="block mb-2 text-sm font-bold text-violet-900">
          ...
          {/* === NEW CUSTOMER FIELDS === */}
          {customerType === 'new' && (
            <div className="mb-4 p-5 rounded-lg border border-violet-100 bg-violet-50/30">
              <h3 className="text-base font-bold text-violet-900 mb-4 flex items-center gap-2">
                <span className="bg-violet-100 text-violet-800 p-1 rounded text-xs">NEW</span> Customer Details
              </h3>
          ...
          <Form.Item className="mt-4 mb-0">
            <Button type="primary" htmlType="submit" block className="bg-violet-600 hover:bg-violet-700 h-10 rounded-md font-semibold shadow-md">
              Submit Enquiry
            </Button>
          </Form.Item>
