			...
			<div>
				...
				<div className="flex mt-20">
					...
					<div className="flex-grow p-7">
						...
						<DataTable
						Icon={<MdGroupWork  className={`text-4xl rounded-full border-2 border-primary-variant`}/>}
						ClickableIcon={<MdLibraryAdd className="sm:text-4xl " />}
						iconName="Groups"
						clickableIconName="Add Groups"
							catcher="_id"
							onClickHandler={() => {
								setShowModal(true);
								setErrors({});
					...
					<div className="py-6 px-5 lg:px-8 text-left">
						...
						<form className="space-y-6" onSubmit={handleSubmit} noValidate>
							...
							<div className="flex flex-row justify-between space-x-4">
								<div className="w-1/2">
									...
									<input
										...
										required
										className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg ffocus:ring-custom-blue focus:border-custom-blue w-full p-2.5"
									/>
							...
							<div className="w-full flex justify-end">
								<button
									type="submit"
									className="w-1/4 text-white bg-custom-blue hover:bg-custom-blue hover:bg-opacity-95
              focus:ring-custom-blue outline-none focus:border-custom-blue  font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-lg active:scale-110"
								>
									Save Group
								</button>
							</div>
					...
					<div className="py-6 px-5 lg:px-8 text-left">
						...
						<form className="space-y-6" onSubmit={handleUpdate} noValidate>
							...
							<div className="w-full flex justify-end">
								<button
									type="submit"
									className="w-1/4 text-white bg-custom-blue hover:bg-custom-blue hover:bg-opacity-95 shadow-lg
              focus:ring-custom-blue outline-none  custom-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center active:scale-110"
								>
									Update
								</button>
							</div>
