  ...
  const otherServicesCategories = [
    {
      id: 1,
      title: "Loans",
      description: "Manage customer loan records and applications",
      icon: GiTakeMyMoney,
      href: "/other-service-menu/loan",
      label: "Active Loan Customers",
    ...
    },
    {
      id: 2,
      title: "Pigmy",
      description: "Manage customers pigme savings and records",
      icon: PiCalculatorBold,
      href: "/other-service-menu/pigme",
      label: "Active Pigme Customers",
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Manage and organize loan and pigme customer services
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white/80 backdrop-blur-xl rounded-xl shadow-sm border border-purple-100/50 p-6 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">Services Overview</p>
                    <p className="text-2xl font-bold text-gray-900">Financial Services</p>
                  </div>
                ...
                <div className="mt-4 flex items-center text-sm">
                  ...
                  <span className="text-green-600 font-medium">Growing Portfolio</span>
                </div>
              </div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <p className="text-gray-700 text-sm">
                        Use the Loan directory to manage Loan Information, update loan details and track repayment schedules all in one place
                      </p>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700 text-sm">
                        Use the Pigme directory to manage Pigme Information, update savings records and monitor account balances all in one place
                      </p>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-2 flex-shrink-0"></div>
...
export default OtherServicesMenu;