...
import { Users, Briefcase, ChevronRight, Zap, Shield, UserCheck, Sparkles } from "lucide-react";
            ...
            <div className="mb-12">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1 text-lg">Manage and organize loan and pigme customer services</p>
                </div>
              </div>
            </div>
