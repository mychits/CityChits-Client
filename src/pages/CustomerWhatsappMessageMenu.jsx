...
const CustomerWhatsappMessageMenu = () => {
  const customerwhatsappCategories = [
  
     {
      ...
      href: "/market-menu/whatsapp-marketing/customer-whatsapp-marketing/customer-welcome-message",
    //   target:"_self",
      stats: "Active Customer Whatsapp Message",
    },
     {
      id: 2,
      title: "Chit Plan Whatsapp",
      description: "Chit Plan Whatsapp",
      icon: <FaWhatsapp className="w-8 h-8" />,
      color: "from-violet-600 to-violet-700",
      lightColor: "bg-violet-50",
      borderColor: "border-violet-200",
      href: "/market-menu/whatsapp-marketing/customer-whatsapp-marketing/customer-chitplan-message",
    //   target:"_self",
      stats: "Active Chit Plan Whatsapp Message",
    },
          ...
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900">
               Customer Whatsapp Message Management
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {customerwhatsappCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage Customer whatsapp and more with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default CustomerWhatsappMessageMenu;
