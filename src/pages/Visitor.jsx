                ...
                <div className="flex-1 p-6 md:p-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Link to="/visitor-list" className="group block">
                            <div className="relative h-full overflow-hidden rounded-xl bg-white border border-violet-200 shadow-md hover:shadow-lg transition-all duration-300">
                                
                                {/* Background Gradient Blob */}
                                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-violet-600 to-violet-700 opacity-5 group-hover:opacity-10 rounded-full -mr-16 -mt-16 transition-all duration-300 blur-xl" />

                                <div className="relative p-7">
                                    
                                    {/* Icon */}
                                    <div className="inline-flex items-center justify-center w-14 h-14 bg-violet-50 rounded-lg mb-5 group-hover:scale-105 transition-transform duration-300">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 group-hover:border-gray-200 transition-colors">
                                        ...
                                        <div className="p-1.5 rounded-lg bg-gradient-to-br from-violet-600 to-violet-700 opacity-0 group-hover:opacity-100 transform translate-x-1 group-hover:translate-x-0 transition-all duration-300">
                                ...
                                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-violet-600 to-violet-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            </div>
                        </Link>
