...
const LeadWhatsappMessageMenu = () => {
  const leadwhatsappCategories = [
  
     {
      ...
      href: "/market-menu/whatsapp-marketing/lead-whatsapp-marketing/lead-welcome-message",
    //   target:"_self",
      stats: "Active Lead Whatsapp Message",
    },
     {
      id: 2,
      title: "ReferredBy Whatsapp",
      description: "ReferredBy Whatsapp",
      icon: <FaWhatsapp className="w-8 h-8" />,
      color: "from-violet-600 to-violet-700",
      lightColor: "bg-violet-50",
      borderColor: "border-violet-200",
      href: "/market-menu/whatsapp-marketing/lead-whatsapp-marketing/lead-referredby-message",
    //   target:"_self",
      stats: "Active Lead ReferredBy Whatsapp Message",
    },
          ...
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900">
               Lead Whatsapp Message Management
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {leadwhatsappCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage Lead whatsapp and more with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default LeadWhatsappMessageMenu;
