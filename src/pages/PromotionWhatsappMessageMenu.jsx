...
const PromotionWhatsappMessageMenu = () => {
  const promotionwhatsappCategories = [
  
     {
      ...
      href: "/market-menu/whatsapp-marketing/promo-whatsapp-marketing/what-promo",
    //   target:"_self",
      stats: "Active Promotion Whatsapp Message",
    },
          ...
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900">
               Promotion Whatsapp Message Management
              </h2>
              <p className="text-gray-600 mt-2">
                Manage and organize your Promotion Whatsapp Message
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {promotionwhatsappCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage Promotion whatsapp and more with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default PromotionWhatsappMessageMenu;
