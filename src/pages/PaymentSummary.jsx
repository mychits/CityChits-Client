              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-violet-100 rounded-lg">
                    <FiDollarSign className="text-violet-600 text-xl" />
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex-1 min-w-[200px]">
                  ...
                  <div className="bg-violet-50 border border-violet-200 rounded-md px-3 py-2 text-violet-700 font-semibold h-10 flex items-center">
                    ₹ {summaryTotal.toLocaleString("en-IN", { minimumFractionDigits: 2 })}
                  </div>
                </div>
              </div>
