                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="col-span-2">
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-violet-500 focus:ring-2 focus:ring-violet-200 outline-none"
                    />
                    {errors.mobile && (
                    ...
                    >
                      ...
                      {attachments.length > 0 && (
                        <div className="grid grid-cols-3 gap-2 w-full h-full p-2 overflow-y-auto z-10 bg-white/50">
                          ...
                          {/* Add More Indicator */}
                          <div className="relative h-24 w-full rounded border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 hover:text-violet-500 hover:bg-gray-50 transition">
