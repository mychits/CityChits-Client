...
const PaymentLinkMarketingMenu = () => {
  const paymentlinkmarketingCategories = [
  
    {
      ...
      href: "/market-menu/payment-link-marketing/payment-link",
          ...
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900">
               Payment Link Marketing Management
              </h2>
              <p className="text-gray-600 mt-2">
                Manage and organize your Payment Link Marketing
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {paymentlinkmarketingCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage Payment Link with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default PaymentLinkMarketingMenu;
