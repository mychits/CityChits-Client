...
import { Banknote, Briefcase, TicketCheck, MoreHorizontal, ChevronRight, Zap, Shield, UserCheck, Sparkles, CreditCard, Receipt, ArrowDownCircle, ArrowUpCircle } from "lucide-react";
            ...
            <div className="mb-12">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1 text-lg">Manage and view payment-in and payment-out information</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-700 leading-relaxed">
                    Use the Payment-In directory to manage payment-in transaction details and update payment information all in one place.
                  </p>
                  <p className="text-slate-700 leading-relaxed mt-2">
                    Use the Payment-Out directory to manage payment-out transaction details and update payment information all in one place.
                  </p>
                </div>
              </div>
            </div>
