...
import { Users, Briefcase, ChevronRight, Zap, Shield, UserCheck, Sparkles, ArrowUpRight, Grid3x3 } from "lucide-react";
            ...
            <div className="mb-12">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1 text-lg">Manage and organize your team members</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-700 leading-relaxed">
                    Use the staff directory to manage personnel, update employee information and provide designations all in one place.
                  </p>
                </div>
              </div>
            </div>
