            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 w-full">
              {subMenus.map(({ title, Icon, link }, idx) => (
                <div
                  ...
                  className={`group flex items-center p-2 rounded-3xl shadow-sm cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:bg-violet-200 ${
                    bgColors[idx % bgColors.length]
                  }`}
                >
                  <div className="flex items-center justify-center w-14 h-14 rounded-full mr-3 bg-transparent text-black">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center bg-violet-700 text-white">
