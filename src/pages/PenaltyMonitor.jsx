  ...
  const columns = [
    {
      ...
      render: (row) => (
        <div className="flex items-center">
          <div className="w-12 h-12 rounded-full bg-gradient-to-r from-violet-500 to-purple-600 flex items-center justify-center text-white text-lg font-bold mr-4">
    ...
    },
    {
      ...
      header: "GROUP",
      render: (row) => (
        <div className="px-3 py-2 bg-violet-50 text-violet-700 rounded-lg font-semibold text-base">
          {row.group}
        </div>
      )
    },
              ...
              <Card className="h-full shadow-xl hover:shadow-2xl transition-all duration-300 border-0 rounded-2xl overflow-hidden">
                <div className="bg-gradient-to-r from-violet-500 to-purple-600 p-4">
                  <div className="flex items-center justify-between text-white">
                    <div>
                      <div className="text-violet-100 text-sm font-medium mb-1">TOTAL EXPECTED</div>
            ...
            <Col xs={24} sm={12} lg={6}>
              <Card className="h-full shadow-xl hover:shadow-2xl transition-all duration-300 border-0 rounded-2xl overflow-hidden">
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4">
                  <div className="flex items-center justify-between text-white">
                    <div>
                      <div className="text-purple-100 text-sm font-medium mb-1">TOTAL PENALTY</div>
                      <div className="text-3xl font-bold">
              ...
              <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-0 rounded-2xl">
                <div className="flex items-center justify-between p-2">
                  <div>
                    ...
                    <div className="text-4xl font-bold text-purple-500">{withinGraceCount}</div>
              ...
              <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-0 rounded-2xl">
                <div className="flex items-center justify-between p-2">
                  <div>
                    ...
                    <div className="text-4xl font-bold text-violet-600">{data.length}</div>
          ...
          <Card
            ...
            title={
              <div className="flex items-center justify-between">
                ...
                {dateRange.length === 2 && (
                  <div className="text-base text-gray-600 font-medium bg-violet-50 px-4 py-2 rounded-lg">
          ...
          >
            {isLoading ? (
              <div className="flex items-center justify-center py-32">
                <CircularLoader color="text-violet-600" />
              </div>
