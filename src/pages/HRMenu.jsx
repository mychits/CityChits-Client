          ...
          <div className="p-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Use the Payroll Management directory to manage employee personnel, update employee information and Provide Designation all in one place.</p>
              </div>
            </div>
          </div>
          </div>
