...
const RCSMarketingMenu = () => {
  const rcsmarketingCategories = [
  
    {
      id: 1,
      title: "RCS ",
      description: "Manage RCS Login",
      icon: <MdOutlineTextsms className="w-8 h-8" />,
      color: "from-violet-600 to-violet-700",
      lightColor: "bg-violet-50",
      borderColor: "border-violet-200",
      href: "/market-menu/rcs-marketing/payment-link",
      stats: "Active RCS",
    },
          ...
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-900">
               RCS Marketing Management
              </h2>
              <p className="text-gray-600 mt-2">
                Manage and organize your SMS Message Marketing
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {rcsmarketingCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Manage RCS with Marketing Management—everything in one place.</p>
              </div>
            </div>
          </div>
          </div>
...
export default RCSMarketingMenu;
