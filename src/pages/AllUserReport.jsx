...
const AllUserReport = () => {
  ...
  // Simplified transformUserData function without penalty details
    ...
    const fetchData = async () => {
      try {
        ...
        const transformedData = reportData.map((userInfo, index) => {
          return transformUserData(userInfo, index);
        });
  ...
  <div className="max-w-7xl mx-auto w-full">
     ...
     <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
              {/* Total Customers */}
              <div className="bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform duration-200 flex flex-col justify-between h-full relative overflow-hidden">
