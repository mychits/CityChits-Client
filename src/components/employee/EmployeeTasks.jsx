          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex bg-white p-1 rounded-lg border border-gray-300 shadow-sm">
              <button
                ...
                className={`p-2 rounded-md ${viewMode === 'list' ? 'bg-violet-100 text-violet-600' : 'text-gray-400 hover:bg-gray-100'}`}
              >
                <List size={20} />
              </button>
              <button
                onClick={() => setViewMode('grid')}
                className={`p-2 rounded-md ${viewMode === 'grid' ? 'bg-violet-100 text-violet-600' : 'text-gray-400 hover:bg-gray-100'}`}
              >
                <LayoutGrid size={20} />
              </button>
            </div>
      ...
      >
        <Form form={completionForm} layout="vertical" onFinish={handleCompleteSubmit}>
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button type="submit" className="px-4 py-2 bg-violet-600 text-white rounded hover:bg-violet-700">Submit</button>
          </div>
        </Form>
      </Modal>
